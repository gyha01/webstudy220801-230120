...
console.group('1) 이상, 이하, 미만, 초과');
    console.log(compare1); //100은 50 '이상'이다 --> 참 -> true
    console.log(compare2); //100은 50을 '초과'한다 --> 참 -> true
    console.log(compare3); //100은 50 '이하'이다 --> 거짓 -> false
    console.log(compare4); //100은 50 '미만'이다 --> 거짓 -> false
console.groupEnd();
